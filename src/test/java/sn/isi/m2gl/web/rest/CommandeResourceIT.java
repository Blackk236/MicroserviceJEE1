...
import sn.isi.m2gl.repository.CommandeRepository;
...
class CommandeResourceIT {
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande().numero(DEFAULT_NUMERO).date(DEFAULT_DATE);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande().numero(UPDATED_NUMERO).date(UPDATED_DATE);
        return commande;
    }
    ...
    void putNewCommande() throws Exception {
        ...
        updatedCommande.numero(UPDATED_NUMERO).date(UPDATED_DATE);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.numero(UPDATED_NUMERO).date(UPDATED_DATE);
